...
test.describe('Dashboard', () => {
  ...
  authenticatedTest('should display dashboard with correct components', async ({ dashboardPage }) => {
...
test.describe('Dashboard - Task Management', () => {
  ...
  authenticatedTest('should create a task and see it reflected in dashboard stats', async ({ 
    dashboardPage, 
    tasksPage 
  }) => {
    // Get initial stats
